  ...
  return (
    <main>
      <Box sx={{display: "flex", flexDirection: "row", justifyContent: "space-between", marginTop: "10px", px: "20px"}}>
        ...
        <Button sx={{backgroundColor: "#98ca3f", color: "#121f3d", "&:hover": {backgroundColor: "#121f3d", color: "#98ca3f", border: "1px solid #98ca3f"}}} onClick={() => {setFilter(null)}}>
          Reset
        </Button>
      </Box>
      <CategoriesCarousel categories={categories} setFilter={setFilter}/>
